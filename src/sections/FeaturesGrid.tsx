                        ...
                        <div className="col-span-2">
                            ...
                            <ul className="mt-12 flex flex-col gap-8">
                                {listItems.map((item, index) => (
                                    ...
                                    >
                                        <div className="inline-flex size-8 flex-shrink-0 items-center justify-center rounded-full outline outline-4 -outline-offset-4 outline-fuchsia-500/20">
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="mt-6 flex flex-col gap-6 text-xl text-zinc-400 lg:text-2xl">
                                ...
                                <p>
                                    ...
                                    scalable, user—friend Apps with low
